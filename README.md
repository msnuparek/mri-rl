...
mri-rl/
├── assets/
│   └── system_workflow.gif  # optional README GIF visualization
│
├── rl/
...
To display this animation in the README, copy the generated GIF into the documented assets path:

```bash
mkdir -p assets
cp outputs/rl_episode.gif assets/system_workflow.gif
```
